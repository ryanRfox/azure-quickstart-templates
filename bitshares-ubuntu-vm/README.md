...
This template uses the Azure Linux CustomScript extension to deploy a BitShares Node on the TESTNET containing both a witness node and graphical user interface web wallet.  The deployment template creates an Ubuntu 16.04 LTS VM, installs the BitShares witness node and GUI wallet.  The bits will build from github source.   
