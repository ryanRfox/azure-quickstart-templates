# BitShares witness node and GUI wallet on Ubuntu 15.10 VM
...
This template uses the Azure Linux CustomScript extension to deploy a BitShares Node containing both a witness node and graphical user interface web wallet.  The deployment template creates an Ubuntu 15.10 VM, installs the BitShares witness node and GUI wallet.  You may select to build from source or install from PPA.   
